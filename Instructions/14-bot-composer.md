...
2. On the **Home** screen, select **+ Create New**. Then create a new empty bot; naming it **WeatherBot** and saving it in a local folder.
...
4. In the properties pane on the left, edit the title of **Greeting** by selecting the word **Greeting** at the top of the properties pane on the right and changing it to **WelcomeUsers**.
